...
import (
	"context"
	webDI "github.com/krls256/dsd2024additional/internal/web/di"
...
func main() {
	...
	defs, pgSQLMigrations := webDI.Defs(), []pgsql.SmartEmbed{}

	ctn, err := pkgDI.Build("./config.web.yml", pgSQLMigrations, defs...)
	if err != nil {
		panic(err)
	}
